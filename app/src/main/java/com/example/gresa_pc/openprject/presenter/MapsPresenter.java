...
public class MapsPresenter implements DirectionFinderContract.LoadListenerDirectionFinder, ParkingSitesContract.LoadListenerParkingSites {
    ...
    private final ParkingSitesContract mParkingSitesContract;
    private MapsView mView;
    private final DirectionFinderContract mDirectionFinderContract;
    ...
    public MapsPresenter(DirectionFinderContract mDirectionFinderContract, ParkingSitesContract mParkingSitesContract) {
        this.mDirectionFinderContract = mDirectionFinderContract;
        this.mParkingSitesContract = mParkingSitesContract;
    }
    ...
    public void onResumeDirectionFinder(MapsView view, GoogleMap mMap, String origin, String destination, String key, boolean alternatives) {
        ...
        mDirectionFinderContract.getDirectionRoutes(this, origin, destination, key, alternatives);
    }
    ...
    public void onResumeParkingSites(MapsView view, GoogleMap mMap) {
        ...
        this.mMap = mMap;
        mView.showProgressDialog();
        mParkingSitesContract.getParkingSites(this);
    }
    ...
    public void onLoadedDirectionFinder(List<Route> routes) {
        ...
        List<ParkingSite> nearParkingSites = showNearParkingSites(routes, this.mParkingSites);
    ...
    private List<ParkingSite> showNearParkingSites(List<Route> routes, List<ParkingSite> parkingSites) {
    ...
    public void selectRoute(String detail) {
        ...
        if (!mParkingSites.isEmpty() && mParkingSites != null) {
            List<ParkingSite> nearParkingSites = showNearParkingSites(selectedRoute, mParkingSites);
            showParkingSites(nearParkingSites, ZOOM_INDEX_LOW);
        }
    }
